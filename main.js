function myFunct() {
    ...
    if (month == "Jan" || month == "January" || month == "jan" || month == "january") {
        ...
        document.getElementById("result").innerHTML = "Your horoscop is Aquarius"
        ...
        document.body.appendChild(x);
        document.getElementById("result").innerHTML = "Your horoscop is Pisces"
        ...
        document.body.appendChild(x);
        document.getElementById("result").innerHTML = "Your horoscop is Aries"
        ...
        document.body.appendChild(x);
        document.getElementById("result").innerHTML = "Your horoscop is Taurus"
        ...
        document.body.appendChild(x);
        document.getElementById("result").innerHTML = "Your horsoscop is Gemini"
        ...
        document.body.appendChild(x);
        document.getElementById("result").innerHTML = "Your horoscop is Cancer"
        ...
        document.body.appendChild(x)
        document.getElementById("result").innerHTML = "Your horoscop is Leo"
        ...
        document.body.appendChild(x)
        document.getElementById("result").innerHTML = "Your horoscop is Virgo"
        ...
        document.body.appendChild(x)
        document.getElementById("result").innerHTML = "Your horoscop is Libra"
        ...
        document.body.appendChild(x)
        document.getElementById("result").innerHTML = "Your horoscop is Scorpio"
        ...
        document.body.appendChild(x)
        document.getElementById("result").innerHTML = "Your horoscop is Sagittarius"
        ...
        document.body.appendChild(x)
        document.getElementById("result").innerHTML = "Your horoscop is Capricorn"
